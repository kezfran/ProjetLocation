...
namespace ProjetLocation.exception.dao
{
    class InvalidSortByPropertyException : Exception
    {
        ///<summary>
        ...
        ///</summary>
        public InvalidSortByPropertyException() : base() { }
        ///<summary>
        ...
        ///</summary>
        public InvalidSortByPropertyException(string message) : base(message) { }
    }
}
